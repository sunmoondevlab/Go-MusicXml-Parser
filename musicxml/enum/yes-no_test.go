...
func TestToYesNo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := ToYesNo(tt.args.t)
			if (err != nil) != tt.wantErr {
				t.Errorf("ToYesNo() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("ToYesNo() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestAllYesNoEnumValues(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("AllYesNoEnumValues() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestYesNoEnum_Equals(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("YesNoEnum.Equals() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestYesNoEnum_In(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("YesNoEnum.In() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestYesNoEnum_Ordinal(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tt.e.Ordinal()
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("YesNoEnum.Ordinal() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestYesNoEnum_String(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tt.e.String()
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("YesNoEnum.String() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
...
func TestYesNoEnum_StringPtr(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tt.e.StringPtr()
			if diff := cmp.Diff(got, tt.want); diff != "" {
				t.Errorf("YesNoEnum.StringPtr() value is mismatch (-got, +want):%s\n", diff)
			}
		})
	}
}
